  ...
  return (
    <>
      ...
      <div className="fixed-icons">
        <a
          href="https://api.whatsapp.com/send?phone=917025306368"
          target="_blank"
          className="icon-link whatsapp-icon"
        >
          <i className="fa-brands fa-whatsapp"></i>
        </a>
        <a className="icon-link question-icon" onClick={handleOpen}>
        ...
        <div className={`menu ${menuActive ? 'active' : ''}`}>
          ...
          <ul className="menu-list mt-5">
            ...
            <li>
              ...
              >
                WHO WE ARE <i className="fas fa-arrow-right"></i>
              </a>
