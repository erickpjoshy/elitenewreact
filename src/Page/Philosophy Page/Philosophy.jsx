    ...
    $(document).ready(function () {
      ...
      $(window).on('scroll', function () {
        ...
        if ($(window).scrollTop() > 0) {
          ...
          logo.attr(
            'src',
            '/src/assets/ezgif.com-webp-to-png-converter (1).png'
          );
        } else {
          header.removeClass('header-bg');
          logo.attr('src', '/src/assets/elite_flag_log.png');
        }
      });
    ...
    <div>
      ...
      <div className="container mt-5">
        <div className="heading-container mt-5">
          <span className="heading-text font">Our Logo</span>
        </div>
      ...
      <div className="heading-container mt-5">
        <span className="heading-text font">Our Journey</span>
      </div>
